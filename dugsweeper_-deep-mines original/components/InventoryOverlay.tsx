...
const InventoryOverlay: React.FC<InventoryOverlayProps> = ({ inventory, onClose }) => {
  const items = [
    ...
    { 
      ...
      icon: '⬜', 
      description: 'High-purity silver ore found in deep strata. Valuable trade commodity.' 
    }
  ...
  return (
    <div className="fixed inset-0 z-[150] flex items-center justify-center bg-black/80 backdrop-blur-sm p-4 animate-in fade-in zoom-in duration-200 font-mono select-none">
      <div className="w-full max-w-4xl bg-slate-900 border-4 border-slate-600 shadow-2xl rounded-sm overflow-hidden flex flex-col h-[600px]">
        ...
        <div className="bg-slate-800 p-4 border-b border-slate-600 flex justify-between items-center">
            ...
            <div className="text-[10px] text-slate-500 font-mono">PRESS [I] TO CLOSE</div>
        </div>
