...
const GameHUD: React.FC<GameHUDProps> = ({
    ...
    return (
        <>
            ...
            <div className={`absolute top-0 ${isMobile ? 'left-0' : 'left-64'} right-0 z-[70] bg-stone-900/90 border-b border-stone-800 p-4 flex justify-between items-center backdrop-blur-md`}>
            ...
            {message && (
                <div className="fixed top-20 left-0 right-0 z-[100] flex justify-center pointer-events-none px-4">
                    <div className={`text-white px-4 py-2 rounded font-bold uppercase text-sm text-center shadow-lg border-2 max-w-[90%] pointer-events-auto ${message.includes('+')
            ...
            {/* Left Sidebar Info - uses absolute positioning relative to game container. HIDDEN ON MOBILE to prevent obscuring game. */}
            {!isMobile && (
