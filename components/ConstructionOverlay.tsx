        ...
        <div className="p-6 space-y-4 bg-[radial-gradient(circle_at_center,rgba(60,60,60,0.5),rgba(20,20,20,0.8))]">
          ...
          <div className="flex gap-4 mb-6 bg-black/40 p-3 border border-stone-700">
            <div className="flex-1 text-center">
              <div className="text-[10px] text-stone-500 uppercase font-bold">Stone</div>
              <div className="text-xl font-black text-stone-300">🪨 {inventory.stone}</div>
            </div>
            <div className="flex-1 text-center border-l border-stone-700">
              <div className="text-[10px] text-stone-500 uppercase font-bold">Silver</div>
              <div className="text-xl font-black text-stone-300">🥈 {inventory.silverBlocks}</div>
            </div>
          </div>
              ...
              >
                ...
                <div className="flex items-center gap-4 mb-3">
                  ...
                  <div className="flex-1">
                    <div className="text-sm font-bold text-white uppercase">{project.name}</div>
                    <div className="text-[9px] text-stone-400 uppercase tracking-tight">{project.desc}</div>
                  </div>
                  {project.built && (
                    <span className="px-3 py-1 bg-green-600 text-white text-xs font-black uppercase">ACTIVE</span>
                  )}
                </div>
                    ...
                    <div className="flex gap-3">
                      ...
                      >
                        <div className="flex items-center justify-between mb-1">
                          ...
                          <span className={`text-xs font-black ${stoneComplete ? 'text-green-400' : 'text-stone-400'}`}>
                        ...
                        {!stoneComplete && inventory.stone > 0 && (
                          <div className="text-[8px] text-orange-400 mt-1 uppercase">← → to select, ENTER to add</div>
                        )}
                        {stoneComplete && <div className="text-[8px] text-green-400 mt-1 uppercase">✓ Complete</div>}
                      </button>
                      ...
                      >
                        <div className="flex items-center justify-between mb-1">
                          <span className="text-lg">🥈</span>
                          <span className={`text-xs font-black ${silverComplete ? 'text-green-400' : 'text-stone-400'}`}>
                        ...
                        {!silverComplete && inventory.silverBlocks > 0 && (
                          <div className="text-[8px] text-orange-400 mt-1 uppercase">← → to select, ENTER to add</div>
                        )}
                        {silverComplete && <div className="text-[8px] text-green-400 mt-1 uppercase">✓ Complete</div>}
                      </button>
                    </div>
                  </>
                )}
